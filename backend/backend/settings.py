...
ALLOWED_HOSTS = ['taskimaxivasi.ddns.net', '51.250.107.37', '127.0.0.1', 'localhost']
...
# Теперь Django будет искать файл БД в директории data/.
# Чтобы новые настройки приложения попали в контейнер,
